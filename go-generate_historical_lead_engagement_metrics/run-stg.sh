...
DEPOSIT_NAME="$ENV-go-generate-historical-lead-engagement-metrics"
IMAGE_REGION="europe-west1"
IMAGE_NAME="$ENV-go-generate_historical_lead_engagement_metrics"
...
kubectl delete job stg-go-generate-historical-lead-engagement-metrics --ignore-not-found

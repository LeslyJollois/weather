...
DEPOSIT_NAME="$ENV-go-generate-top-next-articles"
IMAGE_REGION="europe-west1"
IMAGE_NAME="$ENV-go-generate_top_next_articles"
...
kubectl delete job stg-go-generate-top-next-articles --ignore-not-found

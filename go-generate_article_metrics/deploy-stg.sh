...
DEPOSIT_NAME="$ENV-go-generate-article-metrics"
IMAGE_REGION="europe-west1"
IMAGE_NAME="$ENV-go-generate_article_metrics"
...
kubectl delete job stg-go-generate-article-metrics --ignore-not-found

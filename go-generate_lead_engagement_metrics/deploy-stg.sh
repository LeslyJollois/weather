...
DEPOSIT_NAME="$ENV-go-generate-lead-engagement-metrics"
IMAGE_REGION="europe-west1"
IMAGE_NAME="$ENV-go-generate_lead_engagement_metrics"
...
kubectl delete job stg-go-generate-lead-engagement-metrics --ignore-not-found

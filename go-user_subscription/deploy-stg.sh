...
DEPOSIT_NAME="$ENV-go-user-subscription"
IMAGE_REGION="europe-west1"
IMAGE_NAME="$ENV-go-user_subscription"
CONTAINER_NAME="$ENV-go-user-subscription"
DEPLOYMENT_NAME="$ENV-go-user-subscription"
NAMESPACE="default"

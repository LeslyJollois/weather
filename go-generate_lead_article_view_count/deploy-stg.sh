...
DEPOSIT_NAME="$ENV-go-generate-lead-article-view-count"
IMAGE_REGION="europe-west1"
IMAGE_NAME="$ENV-go-generate_lead_article_view_count"
...
kubectl delete job stg-go-generate-lead-article-view-count --ignore-not-found

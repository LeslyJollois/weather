...
DEPOSIT_NAME="$ENV-go-generate-user-sd-profile"
IMAGE_REGION="europe-west1"
IMAGE_NAME="$ENV-go-generate_user_sd_profile"
...
kubectl delete job stg-go-generate-user-sd-profile --ignore-not-found

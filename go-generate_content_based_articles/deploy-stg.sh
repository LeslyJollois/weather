...
DEPOSIT_NAME="$ENV-go-generate-content-based-articles"
IMAGE_REGION="europe-west1"
IMAGE_NAME="$ENV-go-generate_content_based_articles"
...
kubectl delete job stg-go-generate-content-based-articles --ignore-not-found

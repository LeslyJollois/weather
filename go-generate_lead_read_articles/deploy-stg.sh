...
DEPOSIT_NAME="$ENV-go-generate-lead-read-articles"
IMAGE_REGION="europe-west1"
IMAGE_NAME="$ENV-go-generate_lead_read_articles"
...
kubectl delete job stg-go-generate-lead-read-articles --ignore-not-found

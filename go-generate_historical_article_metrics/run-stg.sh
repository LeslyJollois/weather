...
DEPOSIT_NAME="$ENV-go-generate-historical-article-metrics"
IMAGE_REGION="europe-west1"
IMAGE_NAME="$ENV-go-generate_historical_article_metrics"
...
kubectl delete job stg-go-generate-historical-article-metrics --ignore-not-found

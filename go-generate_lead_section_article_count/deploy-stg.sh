...
DEPOSIT_NAME="$ENV-go-generate-lead-section-article-count"
IMAGE_REGION="europe-west1"
IMAGE_NAME="$ENV-go-generate_lead_section_article_count"
...
kubectl delete job stg-go-generate-lead-section-article-count --ignore-not-found

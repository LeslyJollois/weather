...
DEPOSIT_NAME="$ENV-go-generate-article-content-vector"
IMAGE_REGION="europe-west1"
IMAGE_NAME="$ENV-go-generate_article_content_vector"
...
kubectl delete job stg-go-generate-article-content-vector --ignore-not-found

...
DEPOSIT_NAME="$ENV-go-generate-lead-event-fixtures"
IMAGE_REGION="europe-west1"
IMAGE_NAME="$ENV-go-generate_lead_event_fixtures"
...
kubectl delete job stg-go-generate-lead-event-fixtures --ignore-not-found
